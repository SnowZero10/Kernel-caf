...
**
** $Id: proslic.c 5183 2015-10-15 15:45:46Z nizajerk $
**
** Distributed by:
...
{
    int i,j;
    uInt8 intData[SI_MAX_INTERRUPTS] = {0};
    uInt8 *currentData;
    uInt8 map, intCount;
...
*/
int ProSLIC_CreatePSTNCheckObjs(proslicPSTNCheckObjType_ptr *pstnCheckObj, unsigned int num_objs)
{
...
#ifdef PSTN_DET_ENABLE
int ProSLIC_CreateDiffPSTNCheckObj(proslicDiffPSTNCheckObjType_ptr *pstnCheckObj, unsigned int num_objs)
{
#ifndef DISABLE_MALLOC
...
*/
#ifdef PSTN_DET_ENABLE
int ProSLIC_DestroyDiffPSTNCheckObjs(proslicDiffPSTNCheckObjType_ptr *pstnCheckObj)
{
#ifndef DISABLE_MALLOC
    if(pstnCheckObj)
