...
**
** $Id: proslic.h 5185 2015-10-15 21:31:43Z nizajerk $
**
** Distributed by:
 ...
 * @deprecated This function is slated to be removed in the next major API release.
 */
...
int ProSLIC_CreateDiffPSTNCheckObjs(proslicDiffPSTNCheckObjType_ptr *pstnCheckObj, unsigned int num_objs);
